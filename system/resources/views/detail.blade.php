      ...
      <div class="card">
          <div class="container">
              <div class="row mt-5 mb-5">
                  ...
                  <h4 class="shirt_text" style="text-align:left">Start Price : Rp. 65.000</h4> <hr>
                    <label for=""> Detail</label>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consequuntur rem aspernatur est laborum ad maiores ipsam molestiae eos aperiam vel doloremque expedita atque itaque velit iure, nihil consectetur et vitae!</p>
